...
#ifndef __GLC_A0_VMX_VMCS_ACCESSORS_H__
#define __GLC_A0_VMX_VMCS_ACCESSORS_H__
...
///         This accessor function provide the fastest read access to
///         a given VMCS without having to worry about VMCS field/component cacheability.
///         Accessor active for this VT-cached VMCS field.
/// @param  VMCS_T_PTR   Pointer to an active (potentially cacheable fields) VMCS.
...
////////////////////////////////////////////////////////////////////////////
// Rd_RSVD_64_BIT_Control_3()
/// @brief  Returns the value of the <tt> RSVD_64_BIT_Control_3 </tt> field from a given VMCS.
///         This accessor function helps provide the fastest read access to
///         a given VMCS without having to worry about VMCS field/component cacheability.
///         Accessor active for this VT-cached VMCS field.
/// @param  VMCS_T_PTR   Pointer to an active (potentially cacheable fields) VMCS.
/// @return <tt> uint64_t    </tt> read from the <tt> RSVD_64_BIT_Control_3 </tt> field of the specified VMCS.
////////////////////////////////////////////////////////////////////////////

#define Rd_RSVD_64_BIT_Control_3( VMCS_T_PTR )  \
            ( *((uint64_t    *) (((uint8_t *) (VMCS_T_PTR)) + VMX_RSVD_64_BIT_CONTROL_3_FULL_OFFSET)) )

////////////////////////////////////////////////////////////////////////////
// Wr_RSVD_64_BIT_Control_3()
/// @brief  Writes value <tt> val </tt> into the the <tt> RSVD_64_BIT_Control_3 </tt> field a given VMCS.
///         This accessor function helps provide the fastest write access to
///         a given VMCS without having to worry about VMCS field/component cacheability.
///         Accessor active for this VT-cached VMCS field.
/// @param  VMCS_T_PTR    Pointer to an active (potentially cacheable fields) VMCS.
/// @param  VAL             uint64_t    value to be written into the VMCS.RSVD_64_BIT_Control_3 field.
/// @return No return value.
////////////////////////////////////////////////////////////////////////////

#define Wr_RSVD_64_BIT_Control_3( VMCS_T_PTR, VAL )  \
            (*((uint64_t    *) (((uint8_t *) (VMCS_T_PTR)) + VMX_RSVD_64_BIT_CONTROL_3_FULL_OFFSET)) = (VAL))
...
////////////////////////////////////////////////////////////////////////////
// Rd_RSVD_64_BIT_Control_1()
/// @brief  Returns the value of the <tt> RSVD_64_BIT_Control_1 </tt> field from a given VMCS.
///         This accessor function helps provide the fastest read access to
///         a given VMCS without having to worry about VMCS field/component cacheability.
///         Accessor active for this VT-cached VMCS field.
/// @param  VMCS_T_PTR   Pointer to an active (potentially cacheable fields) VMCS.
/// @return <tt> uint64_t    </tt> read from the <tt> RSVD_64_BIT_Control_1 </tt> field of the specified VMCS.
////////////////////////////////////////////////////////////////////////////

#define Rd_RSVD_64_BIT_Control_1( VMCS_T_PTR )  \
            ( *((uint64_t    *) (((uint8_t *) (VMCS_T_PTR)) + VMX_RSVD_64_BIT_CONTROL_1_FULL_OFFSET)) )

////////////////////////////////////////////////////////////////////////////
// Wr_RSVD_64_BIT_Control_1()
/// @brief  Writes value <tt> val </tt> into the the <tt> RSVD_64_BIT_Control_1 </tt> field a given VMCS.
///         This accessor function helps provide the fastest write access to
///         a given VMCS without having to worry about VMCS field/component cacheability.
///         Accessor active for this VT-cached VMCS field.
/// @param  VMCS_T_PTR    Pointer to an active (potentially cacheable fields) VMCS.
/// @param  VAL             uint64_t    value to be written into the VMCS.RSVD_64_BIT_Control_1 field.
/// @return No return value.
////////////////////////////////////////////////////////////////////////////

#define Wr_RSVD_64_BIT_Control_1( VMCS_T_PTR, VAL )  \
            (*((uint64_t    *) (((uint8_t *) (VMCS_T_PTR)) + VMX_RSVD_64_BIT_CONTROL_1_FULL_OFFSET)) = (VAL))
...
////////////////////////////////////////////////////////////////////////////
// Rd_Pid_Ptr_TABLE_Size()
/// @brief  Returns the value of the <tt> Pid_Ptr_TABLE_Size </tt> field from a given VMCS.
///         This accessor function helps provide the fastest read access to
///         a given VMCS without having to worry about VMCS field/component cacheability.
///         Accessor active for this VT-cached VMCS field.
/// @param  VMCS_T_PTR   Pointer to an active (potentially cacheable fields) VMCS.
/// @return <tt> uint16_t    </tt> read from the <tt> Pid_Ptr_TABLE_Size </tt> field of the specified VMCS.
////////////////////////////////////////////////////////////////////////////

#define Rd_Pid_Ptr_TABLE_Size( VMCS_T_PTR )  \
            ( *((uint16_t    *) (((uint8_t *) (VMCS_T_PTR)) + VMX_PID_POINTER_TABLE_SIZE_OFFSET)) )

////////////////////////////////////////////////////////////////////////////
// Wr_Pid_Ptr_TABLE_Size()
/// @brief  Writes value <tt> val </tt> into the the <tt> Pid_Ptr_TABLE_Size </tt> field a given VMCS.
///         This accessor function helps provide the fastest write access to
///         a given VMCS without having to worry about VMCS field/component cacheability.
///         Accessor active for this VT-cached VMCS field.
/// @param  VMCS_T_PTR    Pointer to an active (potentially cacheable fields) VMCS.
/// @param  VAL             uint16_t    value to be written into the VMCS.Pid_Ptr_TABLE_Size field.
/// @return No return value.
////////////////////////////////////////////////////////////////////////////

#define Wr_Pid_Ptr_TABLE_Size( VMCS_T_PTR, VAL )  \
            (*((uint16_t    *) (((uint8_t *) (VMCS_T_PTR)) + VMX_PID_POINTER_TABLE_SIZE_OFFSET)) = (VAL))
...
#endif // __GLC_A0_VMX_VMCS_ACCESSORS_H__
